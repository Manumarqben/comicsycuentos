<footer
    class="py-14 items-center overflow-hidden bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 z-40 sticky top-full">
                ...
                <div
                    ...
                    <ul role="list" class="space-y-8" x-data>
                        <li class="flex items-center space-x-3 hover:text-sky-400 transition cursor-pointer"
                            @click="window.open('https://twitter.com/', 'CyC', 'fullscreen=yes')">
