...
class AgeSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('ages')->insert([
            'id' => '1',
            'name' => '6',
            'description' => 'Adecuados para todos los grupos de edad. Las obras no contienen imágenes que puedan asustar a los niños pequeños. Una forma muy leve de violencia (en un contexto cómico o en un entorno infantil) es aceptable. No se lee un lenguaje soez.',
        ]);
        DB::table('ages')->insert([
            'id' => '2',
            'name' => '9',
